...
$img = $client->tienda->img->findOne(['prod' => $key]);

if($aux%2 == 0){ ?>
        <a style="text-decoration: none;" href="/pages/prod.php?key=<?php echo $producto['_id']?>">
        <div class="container py-3 no-underline">
            <div class="row justify-content-around my-3">
                <figure class="col-6 figure my-3 row justify-content-center">
		            <img style="height: 20vw" src="<?php echo $img['img'] ?>" class="figure-img img-fluid rounded" alt="...">
                </figure>
