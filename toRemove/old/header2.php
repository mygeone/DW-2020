...
<nav class="navbar fixed-top navbar-expand-lg navbar-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <li class="nav-item"><a style="color: #A28E8A;" class="nav-link" href="/index.php#about">About</a></li>
      <li class="nav-item"><a style="color: #A28E8A" class="nav-link" href="/index.php#location">Location</a></li>
      ...
      <?php if(isset($_SESSION['usuario'])){ ?>
        <li class="nav-item"><a style="color: #A28E8A;" class="nav-link" href="#">Mi cuenta</a></li>
      <?php }else{ ?>
        <li class="nav-item"><a style="color: #A28E8A;" class="nav-link" href="/login.php">Ingresar</a></li>
      <?php } ?>
    </ul>
  </div>
</nav>